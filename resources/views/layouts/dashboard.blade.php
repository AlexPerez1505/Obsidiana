    ...
    <aside class="sidebar">
        ...
        <nav class="nav">
            ...
            @if (auth()->user()->hasRole('mantenimiento') && ! auth()->user()->isAdmin())
                <a class="nav-item {{ request()->routeIs('mantenimiento.dashboard') ? 'active' : '' }}" href="{{ route('mantenimiento.dashboard') }}" data-tip="Mantenimiento">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>
                    <span class="nav-label">Mantenimiento</span>
                </a>
            @endif
            @if (auth()->user()->hasRole('mantenimiento_externo') && ! auth()->user()->isAdmin())
