...
@section('content')
    <div class="package-form">
        <div class="package-form__header">
            <h2>Nuevo paquete</h2>
            <p>Arma un conjunto de productos que se usan juntos y asígnale un nombre claro.</p>
        </div>
        ...
        <form method="POST" action="{{ route('inventory.paquetes.store') }}">
            ...
            <div class="form-card">
                ...
                <div class="form-field">
                    ...
                    <input id="nombre" type="text" name="nombre" value="{{ old('nombre') }}" placeholder="Ej. Paquete Endoscopía Básico" required>
                </div>
            </div>
                ...
                <table class="products-table">
                    ...
                    <tbody id="productos-body">
                        <tr class="producto-row">
                            <td>
                                <select name="productos[0][id]" class="product-select" required>
                            ...
                            <td>
                                <input type="number" name="productos[0][cantidad]" class="product-qty" value="1" min="1" required>
                            </td>
                            <td></td>
                        </tr>
                    </tbody>
