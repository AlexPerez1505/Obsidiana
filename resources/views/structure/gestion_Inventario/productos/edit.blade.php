            ...
            <x-ui.form-group label="Imagen del Producto" for="imagen">
                @if($producto->imagen_path)
                    <div style="margin-bottom:10px;">
                        ...
                        <small style="color:var(--text-secondary); display:block; margin-top:4px;">Imagen actual</small>
                    </div>
                @endif
                ...
                <small style="color:var(--text-secondary);">Formatos: JPG, PNG, GIF. Máximo 5MB. Deja vacío para mantener la imagen actual.</small>
            </x-ui.form-group>
        </x-ui.card>
