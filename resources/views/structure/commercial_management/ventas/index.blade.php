...
@section('erp_content')
    ...
    <div class="erp-head">
        <div class="erp-head-l">
            ...
            <div>
                <h1 class="erp-h1">Ventas <span class="erp-count">{{ $total }}</span></h1>
                <p class="erp-sub">Ventas confirmadas y en proceso de facturación</p>
            </div>
        </div>
        ...
        <div class="erp-table-wrap">
            <table class="erp-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="7" class="erp-empty">No hay ventas todavía.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
