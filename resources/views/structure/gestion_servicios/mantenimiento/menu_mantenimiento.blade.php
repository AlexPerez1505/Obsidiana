                ...
                <tbody>
                    @forelse ($services as $service)
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($service->status === 'entregado')
                                    <span class="service-badge" style="background: rgba(34,197,94,0.14); color: #22C55E; border: 1px solid rgba(34,197,94,0.4);">Finalizado</span>
                                @else
                                ...
                                <div class="actions-menu" id="{{ $menuId }}">
                                    ...
                                    <div class="actions-menu-dropdown">
                                        ...
                                        @if ($service->currentStep)
                                            @if ($service->status === 'entregado')
                                                <span class="actions-menu-item" style="opacity:0.6; cursor:default;">
