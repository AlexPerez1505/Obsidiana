...
@section('service_content')
    ...
    <div class="ns-page">
        <div class="ns-header">
            <div class="ns-header-title">
                ...
                <div>
                    <h2>Nuevo servicio externo</h2>
                    <p>Crea un nuevo servicio de mantenimiento externo</p>
                </div>
            </div>
        ...
        <div class="catalog-card service-section">
            ...
            <div id="panel-search">
                <form method="GET" action="{{ route('gestion.servicios.nuevo.externo') }}" class="ns-search">
    ...
    <script>
        ...
        function goToEquipment() {
            ...
            // Redirige al paso 2 (Equipo) enviando el cliente seleccionado
            window.location.href = "{{ route('gestion.servicios.nuevo.externo.equipo') }}?customer_id=" + selectedCustomerId;
        }
    </script>
@endsection
