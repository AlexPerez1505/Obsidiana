...
@section('title', 'Área de Endoscopia')
...
<x-ui.card>
    <div class="area-header">
        <div>
            <h1 class="area-title">Área de Endoscopia</h1>
            <p class="area-subtitle">Servicios registrados con equipo de tipo endoscopia</p>
        </div>
    ...
    @else
        <p class="empty-state">No hay servicios con equipo endoscópico registrados.</p>
    @endif
</x-ui.card>
@endsection
