...
@section('title', 'Servicio Externo Externo')
...
@section('erp_content')
    ...
    <div class="erp-head">
        <div class="erp-head-l">
            <h1 class="erp-h1">Servicio externo externo</h1>
        ...
        <div class="erp-table-wrap">
            <table class="erp-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="erp-empty">No hay servicios externos con mantenimiento externo.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
