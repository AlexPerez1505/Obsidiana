...
class ServiceStepsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $steps = [
            ...
            ['name' => 'Aprobación por autoridades', 'slug' => 'aprobacion-autoridades', 'purpose' => 'aprobacion', 'order' => 4, 'requires_qr' => false],
            ...
            ['name' => 'Validación de OS', 'slug' => 'validacion-os', 'purpose' => 'validacion_os', 'order' => 12, 'requires_qr' => false],
