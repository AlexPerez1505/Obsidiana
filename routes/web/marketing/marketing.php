...
Route::middleware(['auth', 'verified', 'approved', 'can:marketing.ver'])->group(function () {
    ...
    Route::get('/marketing/tareas/crear', [TaskController::class, 'create'])
        ->middleware('can:marketing.editar')->name('marketing.tareas.create');

    Route::post('/marketing/tareas', [TaskController::class, 'store'])
        ->middleware('can:marketing.editar')->name('marketing.tareas.store');

    Route::put('/marketing/tareas/{task}', [TaskController::class, 'update'])
        ->middleware('can:marketing.editar')->name('marketing.tareas.update');

    Route::delete('/marketing/tareas/{task}', [TaskController::class, 'destroy'])
        ->middleware('can:marketing.editar')->name('marketing.tareas.destroy');

    Route::put('/marketing/tareas/{task}/aprobar', [TaskController::class, 'aprobar'])
        ->middleware('can:marketing.aprobar')->name('marketing.tareas.aprobar');

    Route::put('/marketing/tareas/{task}/devolver', [TaskController::class, 'devolver'])
        ->middleware('can:marketing.aprobar')->name('marketing.tareas.devolver');

    Route::put('/marketing/tareas/{task}/enviar-revision', [TaskController::class, 'enviarRevision'])
        ->middleware('can:marketing.editar')->name('marketing.tareas.enviar_revision');

    Route::post('/marketing/tareas/preview-link', [TaskController::class, 'previewLink'])
        ->middleware('can:marketing.editar')->name('marketing.tareas.preview_link');

    Route::get('/marketing/aprobacion-flyers', [TaskController::class, 'aprobacionFlyers'])
        ->middleware('can:marketing.aprobar')->name('marketing.aprobacion_flyers.index');
    ...
    Route::get('/marketing/guia-de-marca/crear', [GuiaDeMarcaController::class, 'create'])
        ->middleware('can:marketing.editar')->name('marketing.guia_de_marca.create');

    Route::post('/marketing/guia-de-marca', [GuiaDeMarcaController::class, 'update'])
        ->middleware('can:marketing.editar')->name('marketing.guia_de_marca.update');
